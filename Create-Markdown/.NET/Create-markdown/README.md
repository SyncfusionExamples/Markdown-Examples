...
Step 4: Add the following code snippet in Program.cs  file to create a Markdown document.
...
More information about Markdown library can be found in this [documentation](https://help.syncfusion.com/document-processing/markdown/markdown-library/net/getting-started) section.